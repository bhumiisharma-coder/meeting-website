function animateCounter(element, start, end, duration) {
  ...
  const startValue3 = parseInt(counter3.getAttribute('data-start'), 10)
  const endValue3 = parseInt(counter3.getAttribute('data-end'), 10)
  const duration3 = parseInt(counter3.getAttribute('data-duration'), 10)
  ...
  animateCounter(counter3, startValue3, endValue3, duration3);